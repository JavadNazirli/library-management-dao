...
COPY lib/liquibase-core-4.31.1.jar /app/lib/liquibase-core-4.31.1.jar
COPY changelog.xml /app/changelog.xml
CMD ["sh", "-c", "java -jar lib/liquibase-core-4.31.1.jar --url=jdbc:postgresql://postgres-db:5432/library_db --username=ustam --password=secret123 --changeLogFile=/app/changelog.xml update && java -cp library-management-dao.jar:lib/postgresql-42.7.5.jar:lib/opencsv-5.10.jar:lib/gson-2.12.1.jar:lib/commons-lang3-3.12.0.jar:lib/jackson-dataformat-xml-2.17.2.jar:lib/jackson-core-2.18.3.jar:lib/jackson-annotations-2.18.3.jar:lib/jackson-databind-2.17.2.jar:lib/stax2-api-3.0.1.jar:lib/woodstox-core-7.1.0.jar main.utils.Main"]